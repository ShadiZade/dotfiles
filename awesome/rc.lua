...
--
----------------------------------------------------------------------------------------------------
------ symlink location: ~/.config/awesome/ --------------------------------------------------------
...
-- -- -- From repo: https://github.com/streetturtle/awesome-wm-widgets
...
beautiful.init("/home/oak/.config/awesome/theme.lua")
...
globalkeys = gears.table.join(
    ...
    -- Standard program
    awful.key({ modkey,           }, "q", function () awful.util.spawn("kitty -c=/home/oak/.config/kitty/kitty-awesome.conf") end,
    ...
    awful.key({ modkey },            "a",     function () awful.util.spawn("rofi -show drun") end,
              {description = "rofi desktop launcher", group = "launcher"}),
	...
	-- Vivaldi
     awful.key({ modkey },            "v",     function () awful.util.spawn("vivaldi-stable") end,
	...
	awful.key({},	      "Print", function () awful.spawn("flameshot full") end,
			  {description= "take instant screenshot", group = "awesome"}),
	awful.key({ "Control" },     			      "Print", function () awful.spawn("flameshot gui") end,
			  {description= "take detailed screenshot", group = "awesome"}),
...
awful.rules.rules = {
    ...
    -- Set to always map on tag
     ...
     { rule = { class = "Kodi" },
      properties = { screen = 1, tag = "8", maximized = false, fullscreen = true } },

     { rule = { class = "Emacs" },
      properties = { screen = 1, maximized = false } },
