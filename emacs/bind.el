...
(global-set-key (kbd "<prior>")         (lambda () (interactive) (other-window -1)))
(global-set-key (kbd "<next>")          'other-window)
(global-set-key (kbd "C-<left>")	'delete-window)
(global-set-key (kbd "C-<up>")	        'delete-other-windows)
(global-set-key (kbd "C-<right>")       'split-window-horizontally)
(global-set-key (kbd "C-<down>")        'split-window-vertically)
