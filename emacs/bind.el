...
(keymap-global-set "C-z ~"           'shadi/sign)
(keymap-global-set "C-z a <right>"   'set-buffer-directionality-right)
(keymap-global-set "C-z a <left>"    'set-buffer-directionality-left)
(keymap-global-set "C-z a <prior>"   'shadi/text-force-ltr)
(keymap-global-set "C-z a <next>"    'shadi/text-force-rtl)
...
(keymap-global-set "C-z j"             (lambda () (interactive)
...
;; specific files
(keymap-global-set "C-z e i"           (lambda () (interactive)
					 (find-file "~/Repositories/dotfiles/emacs/init.el")))
(keymap-global-set "C-z e f"           (lambda () (interactive)
					 (find-file "~/Repositories/dotfiles/emacs/functions.el")))         
(keymap-global-set "C-z e h"           (lambda () (interactive)
					 (find-file "~/Repositories/dotfiles/emacs/hooks.el")))                  
(keymap-global-set "C-z e b"           (lambda () (interactive)
